...
{
    public class InsertCommand : CommandBaseFlag, ITodoCommand
    {
        public string optionString { get; private set; } = "--insert";
        public string descriptionString { get; private set; } = "Insert new task.";
        public string aliasString { get; private set; } = "-ins";
