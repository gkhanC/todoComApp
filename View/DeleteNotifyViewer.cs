...
public class DeleteNotifyViewer : TaskViewer
{
    ...
    public override void Show()
    {
        ...
        else
        {
            ...
            Console.WriteLine("The Task deleted.");
            Console.ResetColor();
        }
    ...
    public DeleteNotifyViewer(TodoTask task, ConsoleColorSettings colorSettings) : base(task, colorSettings)
    {
        _task = task;
